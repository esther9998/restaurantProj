              ...
              <div class="item" style="display: none;">
                <div class="media d-block mb-4 text-center ftco-media ftco-animate border-0">
                  ...
                  <div class="media-body p-md-5 p-4">
                    <h5 class="text-primary promo-price">$39.50</h5>
                    <h5 class="mt-0 h4 promo-title">Beef with Sauce</h5>
                    <p class="mb-4 promo-content">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
...
for (var key in data) {
     ...
     if (data.hasOwnProperty(key)) {
    	...
    	/*  var ii = $(".owl-item").eq( $(".owl-item").index( $(element) ) + 1 );
    	 alert(ii); */
    ...
    /* 	 loop: false,
    	 ...
    	 rewind: true */
    	 	...
    	 	//	alert(data[key].idx +"//"+data[key].promo_title);
