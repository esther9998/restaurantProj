...
public class GaTest {
  ...
  private static final String KEY_FILE_LOCATION = "C://Users/Administrator/Downloads/client_secret.json";
  private static final String VIEW_ID = "196870503";
	  public static void main(String[] args) { try { AnalyticsReporting service =
	  initializeAnalyticsReporting();
	  
	  GetReportsResponse response = getReport(service); printResponse(response); }
